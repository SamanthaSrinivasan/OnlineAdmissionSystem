...
export class CollegeCourseService {
  ...
  public getCollegeCourses(): Observable<CollegeCourse[]> {
    return this.http.get<CollegeCourse[]>(
      `${this.apiServerUrl}/CollegeCourse/all`
    );
  }

  public addCollegeCourse(
    collegecourse: CollegeCourse
  ): Observable<CollegeCourse> {
    return this.http.post<CollegeCourse>(
      `${this.apiServerUrl}/CollegeCourse/add`,
      collegecourse
    );
  }

  public deleteCollegeCourse(id: number): Observable<CollegeCourse> {
    return this.http.delete<CollegeCourse>(
      `${baseUrl}/CollegeCourse/delete/${id}`
    );
  }
}
