...
export class ApplicationAddComponent implements OnInit {
  ...
  constructor(
    ...
    private ccs: CollegeCourseService,
    private ucs: UniversityCourseServiceService
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.collegService.getColleges().subscribe((data) => {
      this.colleges = data;
    });
    this.ccs.getCollegeCourses().subscribe((data) => {
      this.collegeCourse = data;
    });

    this.ucs.getUniversityCourses().subscribe((data) => {
