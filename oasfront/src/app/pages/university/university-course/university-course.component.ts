...
export class UniversityCourseComponent implements OnInit {
  ...
  constructor(
    private uniersityCourseService: UniversityCourseServiceService,
  ...
  onSubmit() {
    ...
    this.course.universityCourseName =
      this.universitycourse.universityCourseName;
    this.course.universityCourseDuration =
      this.universitycourse.universityCourseDuration;
  ...
  saveUniversityCourse() {
    this.uniersityCourseService.addUniversityCourse(this.course).subscribe(
      (data) => {
        console.log(data);
